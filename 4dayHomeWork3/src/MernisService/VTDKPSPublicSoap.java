...
public class VTDKPSPublicSoap
{
    ...
    public VTDKPSPublicSoap(){}

    public VTDKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public VTDKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        VTDExtendedSoapSerializationEnvelope envelope= new VTDExtendedSoapSerializationEnvelope(VTDExtendedSoapSerializationEnvelope.VER11);
