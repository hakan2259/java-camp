...
public class VTDExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(VTDDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new VTDStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static VTDDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static VTDDateTimeConverter dateTimeConverter = new VTDStandardDateTimeConverter();

    public VTDExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public VTDExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new VTDMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=VTDHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,VTDExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=VTDHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
